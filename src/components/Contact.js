                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <Row>
                                            ...
                                            <Col size={12} className="px-1">
                                                <textarea rows="6" required value={formDetails.message} placeholder="Message" onChange={(e) => onFormUpdate('message', e.target.value)} />
                                                <div className="d-flex align-items-center">
                                                    <button type="submit"><span>{buttonText}</span></button>
                                                    {
                                                        status.message &&
                                                            <p  style={{paddingLeft: "50px", paddingTop: "35px", fontWeight: "500", fontSize: "20px", color: "#48eca5"}} 
                                                                className={status.success === false ? "danger" : "success"}>{status.message}
                                                            </p>
                                                    }
                                                </div>
                                            </Col>
